import{i as L,a as w,S as C,N as F,P as H,K,r as U,A as J}from"./assets/vendor-BlfOi8zo.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function r(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(n){if(n.ep)return;n.ep=!0;const o=r(n);fetch(n.href,o)}})();function a(e="Щось пішло не так"){L.error({title:"Помилка",message:e,position:"topRight",timeout:4e3})}function W(e="Успішно"){L.success({title:"OK",message:e,position:"topRight",timeout:3e3})}const u=document.querySelector(".furniture-modal"),$=document.querySelector("#modal-close-btn"),S=document.querySelector(".furniture-gallery-modal"),E=document.querySelector(".content-container"),p=document.querySelector("[data-order-modal]"),k=document.querySelector("[data-order-modal-close]"),c=document.querySelector("#orderForm");function G(){document.body.classList.add("body-no-scroll")}function V(){document.body.classList.remove("body-no-scroll")}function z(e){Z(e),u.style.display="flex",G()}function A(){u.style.display="none",V()}$==null||$.addEventListener("click",A);u==null||u.addEventListener("click",e=>{e.target===u&&A()});function Z(e){Q(e),X(e),Y(e)}function Q(e){var o;if(!((o=e.images)!=null&&o.length))return;const[t,...r]=e.images;S.innerHTML=`
    <img src="${t}" alt="${e.name}" class="big-image-sofa" />
    <div class="small-images">
      ${r.map(i=>`<img src="${i}" alt="${e.name}" class="small-image-sofa" />`).join("")}
    </div>
  `;const s=S.querySelector(".big-image-sofa");S.querySelectorAll(".small-image-sofa").forEach(i=>{i.addEventListener("click",()=>{s.src=i.src})})}function X(e){var t;E.innerHTML=`
  ...
  `}function Y(e){const t=E.querySelector(".order-button-modal");t&&t.addEventListener("click",()=>{const r=E.querySelector('input[name="color"]:checked'),s=r?r.value:e.color[0];A(),p.style.display="flex",G(),c.dataset.modelId=e._id,c.dataset.color=s})}k==null||k.addEventListener("click",I);p==null||p.addEventListener("click",e=>{e.target===p&&I()});function I(){p.style.display="none",V()}c==null||c.addEventListener("submit",async e=>{var R,T,_;e.preventDefault();const t=c.querySelector("#orderName").value.trim(),r=c.querySelector("#orderPhone").value.replace(/\D/g,""),s=c.querySelector("#orderComment").value.trim(),n=c.dataset.modelId,o=c.dataset.color;if(!t||!r||!n||!o){a("Будь ласка, заповніть усі обов'язкові поля!");return}if(s&&s.length<5){a("Коментар повинен бути щонайменше 5 символів!");return}const i={name:t,phone:r,modelId:n,color:o,comment:s};console.log("Payload для отправки на сервер:",i);try{const f=await w.post("https://furniture-store-v2.b.goit.study/api/orders",i,{headers:{"Content-Type":"application/json"}});console.log("Ответ сервера:",f.data),W("Заявка успішно надіслана!"),c.reset(),I()}catch(f){console.error("Ошибка при отправке заявки:",((R=f.response)==null?void 0:R.data)||f),a(((_=(T=f.response)==null?void 0:T.data)==null?void 0:_.message)||"Сталася помилка при відправці заявки")}});async function ee(){const e=new URLSearchParams({limit:30,type:"popular"}),t="https://furniture-store-v2.b.goit.study/api/furnitures";try{return(await w(t,{params:e})).data.furnitures}catch(r){return L.error({title:"Помилка",message:`Не вдалося завантажити популярні товари: ${r.message}`,position:"topRight",timeout:4e3}),[]}}const q=document.querySelector(".popular-list"),te=async()=>{const e=await ee();e.length>0?(e.forEach(t=>{q.insertAdjacentHTML("beforeend",`<li class="swiper-slide popular-item">
    ...
    `).join("");le.feedbackList.innerHTML=t}me();function ge(){const e=document.querySelector(".accordion-container");e&&new J(e,{duration:400,showMultiple:!1,collapse:!0,elementClass:"ac",triggerClass:"ac-trigger",panelClass:"ac-panel"})}ge();const h=document.querySelector(".filter-list");async function ye(e){if(h)try{const r=`
      ...
      ${(await ae()).map(s=>`
        ...
        </li>`).join("")}`;h.innerHTML=r,h.addEventListener("click",s=>{const n=s.target.closest(".filter-btn");if(!n)return;const o=n.dataset.categoryId;e==null||e(o||void 0),h.querySelectorAll(".filter-btn").forEach(i=>i.classList.remove("active-filter")),n.classList.add("active-filter")})}catch(t){console.error(t),a("Не вдалося завантажити категорії")}}const b=document.querySelector(".card-list"),m=document.querySelector(".more-btn"),O=document.querySelector(".card-gallery .loader");let x=[],y=0;const M=8;async function be(e){O.classList.remove("hidden");try{return(await oe(1,30,e)).furnitures}catch(t){return console.error(t),a("Не вдалося завантажити меблі"),[]}finally{O.classList.add("hidden")}}async function ve(){return b?(m.style.display="none",await N(void 0),m&&m.addEventListener("click",()=>he()),{setCategory:N}):console.error("Контейнер не знайдено!")}function he(){y+=M,D()}async function N(e){y=0,b.innerHTML="",m.style.display="none";try{x=await be(e),D()}catch(t){b.innerHTML="<p>Помилка завантаження меблів</p>",console.error(t),a("Не вдалося завантажити категорію меблів")}}function D(){const e=x.slice(y,y+M);b.insertAdjacentHTML("beforeend",e.map(t=>`
    ...
    `).join("")),m&&(m.style.display=y+M>=x.length?"none":"block")}b.addEventListener("click",async e=>{const t=e.target.closest(".card-btn");if(!t)return;const r=t.dataset.id;if(r)try{const s=await ce(r);z(s)}catch(s){console.error(s),a("Не вдалося завантажити дані меблів")}});async function Le(){const e=await ve();ye(e.setCategory)}Le();
