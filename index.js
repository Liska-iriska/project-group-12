import{S as $,N as k,P as E,K as A,a as P,i as q,r as C,A as j}from"./assets/vendor-BlfOi8zo.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function s(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(r){if(r.ep)return;r.ep=!0;const o=s(r);fetch(r.href,o)}})();async function x(){const e=new URLSearchParams({limit:30,type:"popular"}),t="https://furniture-store-v2.b.goit.study/api/furnitures";try{return(await P(t,{params:e})).data.furnitures}catch(s){return q.error({title:"Error",message:`An error occurred: ${s.message}`,position:"topRight"}),[]}}const w=document.querySelector(".popular-list"),B=async()=>{const e=await x();e.length>0?e.forEach(t=>w.insertAdjacentHTML("beforeend",`<li class="swiper-slide popular-item">
    ...
    `;t.forEach((r,o)=>{const a=L[o+1]||"";s+=`
      ...
      `}),m.innerHTML=s;const n=m.querySelectorAll(".filter-btn");n.forEach(r=>{r.addEventListener("click",()=>{const o=r.dataset.categoryId;e&&e(o||void 0),n.forEach(a=>a.classList.remove("active-filter")),r.classList.add("active-filter")})})}catch(t){console.error("Ошибка загрузки фильтров:",t)}}const v=document.querySelector(".card-list"),f=document.querySelector(".more-btn");let b=[],l=0;const g=8;async function D(){return v?(await S(void 0),f&&f.addEventListener("click",()=>Z()),{setCategory:S}):console.error("Контейнер для карточек не найден!")}async function J(e){return(await N(1,30,e)).furnitures}function Z(){l+=g,M()}async function S(e){l=0;try{b=await J(e),M()}catch(t){v.innerHTML="<p>Ошибка загрузки мебели</p>",console.error(t)}}function M(){const e=b.slice(l,l+g);v.innerHTML=e.map(t=>`
    ...
    `).join(""),f&&(f.style.display=l+g>=b.length?"none":"block")}D().then(e=>{z(e.setCategory)});document.addEventListener("DOMContentLoaded",()=>{K()});
